<template>
    <div class="container form-page">
        <div class="form-card" v-fade-in>
            <h1>Tambah Produk Bunga</h1>
            <p class="sub">Isi detail produk baru untuk ditambahkan ke katalog</p>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input v-model="form.color" class="form-input" placeholder="Contoh: Merah" />
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input v-model.number="form.price" type="number" min="0" class="form-input"
                            :class="{ error: errors.price }" placeholder="250000" />
                    ...
                    <div class="form-group">
                        ...
                        <input v-model.number="form.stock" type="number" min="0" class="form-input"
                            :class="{ error: errors.stock }" placeholder="10" />
                ...
                <div class="form-group">
                    ...
                    <textarea v-model="form.description" class="form-textarea"
                        placeholder="Deskripsikan produk ini..."></textarea>
                </div>
...
// Integrasi API: Tambah produk (pola sama seperti submitUser() di modul 16)
const submit = async () => {
    if (!validate()) {
    ...
    try {
        ...
        toastStore.add('Produk berhasil ditambahkan', 'success')
        router.push('/kelola-produk')
    } catch (e) {
        toastStore.add('Gagal menambahkan produk', 'error')
    }
}
</script>
